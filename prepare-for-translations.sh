...
java  $JAVA_OPTIONS  -jar ~/source-pkgs/berkeleyparser/berkeleyParser.jar $PARSER_OPTIONS -gr ~/source-pkgs/berkeleyparser/ger_sm5.gr < $DATA_DIR/$FILE_PREFIX.de.20 > $DATA_DIR/$FILE_PREFIX.de.20.parse
